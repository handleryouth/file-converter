import { createTranslation } from "../../i18nType";

export const indonesiaTranslation = createTranslation({
  common: {
    buttons: {
      cancel: "Batal",
      save: "Simpan",
    ...
    mute: "Matikan Suara",
    unmute: "Buka Suara",
    playbackRate: "Kecepatan Playback",
    rotateLeft: "Rotasi Kiri",
    rotateRight: "Rotasi Kanan",
    cut: "Potong",
    after: "Setelah",
    before: "Sebelum",
  },
